...
public class EaglercraftVersion {
	...
	public static final String projectForkName = "CQ Minecraft";
	public static final String projectForkVersion = "1.8";
	public static final String projectForkVendor = "mc.cq.je";
	
	public static final String projectForkURL = "https://mc.cq.je";
